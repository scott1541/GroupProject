...
$(TARGET): ui_application.h ui_login.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents application.h qgrostlhash.h login.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp application.cpp qgrostlhash.cpp login.cpp $(DISTDIR)/
	$(COPY_FILE) --parents application.ui login.ui $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_application.cpp moc_login.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_application.cpp moc_login.cpp
...
compiler_uic_make_all: ui_application.h ui_login.h
compiler_uic_clean:
	-$(DEL_FILE) ui_application.h ui_login.h
